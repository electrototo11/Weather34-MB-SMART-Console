...
<div class="almanac-word"><?php echo $lang['Windspeed'];?></div>
<br><br>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["windmmax"]."<smalltempunit2>".$weather["wind_units"];
...
echo "<div class=tempconverter1><div class=tempmodulehome-10-0c>".$weather["windymax"]."<smalltempunit2>".$weather["wind_units"];
 ?>
</smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["windydmax"]."<smalltempunit2>".$weather["wind_units"];
?><smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["windamax"]."<smalltempunit2>".$weather["wind_units"];
?><smalltempunit2></div></div></div>

<div class="weather-tempicon-identity" style="margin-top:78px;">   
