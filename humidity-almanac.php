...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["humidity_mmax"]."<smalltempunit2>%";
...
echo "<div class=tempconverter1><div class=tempmodulehome-10-0c>".$weather["humidity_ymax"]."<smalltempunit2>%";
 ?>
</smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["humidity_mmin"]."<smalltempunit2>%";
?><smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["humidity_ymin"]."<smalltempunit2>%";
?><smalltempunit2></div></div></div>
