...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["thb0seapressmmax"]."<smalltempunit2>".$weather["barometer_units"] ;
...
echo "<div class=tempconverter1><div class=tempmodulehome-10-0c>".$weather["thb0seapressymax"]."<smalltempunit2>".$weather["barometer_units"] ;
 ?>
</smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome-10-0c>".$weather["thb0seapressmmin"]."<smalltempunit2>".$weather["barometer_units"] ;
?><smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["thb0seapressymin"]."<smalltempunit2>".$weather["barometer_units"] ;
?><smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["thb0seapressamax"]."<smalltempunit2>".$weather["barometer_units"] ;
?><smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["thb0seapressamin"]."<smalltempunit2>".$weather["barometer_units"] ;
?><smalltempunit2></div></div></div>
