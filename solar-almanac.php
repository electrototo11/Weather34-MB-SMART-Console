...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["solarmmax"]	."<smalltempunit2>wm/2";
...
echo "<div class=tempconverter1><div class=tempmodulehome-10-0c>".$weather["solarymax"]."<smalltempunit2>wm/2";
 ?>
</smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["solarydmax"]."<smalltempunit2>wm/2";
?><smalltempunit2></div></div></div>

<div class="almanac4"><div class="almanac-content">
<?php  //min Year
echo "<valuetextheading1>Record Max <deepblue></deepblue></valuetextheading1><br>";
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>N/A<smalltempunit2>";
?><smalltempunit2></div></div></div>
