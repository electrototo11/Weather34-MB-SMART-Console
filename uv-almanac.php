...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["uvmmax"]	."<smalltempunit2>UVI";
...
echo "<div class=tempconverter1><div class=tempmodulehome-10-0c>".$weather["uvymax"]."<smalltempunit2>UVI";
 ?>
</smalltempunit2></div></div></div>
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["uvydmax"]."<smalltempunit2>UVI";
?><smalltempunit2></div></div></div>
