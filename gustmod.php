...
<valuetextheading1><?php echo $lang['Windspeed'];?>&nbsp;&nbsp;</valuetextheading1>
<div class=rainratebar>
<div class="weather34ratebar" 
style="width:
<?php 
if ($weather["wind_units"]=="km/h"){echo $weather['wind_gust_speed']*1.25;}
if ($weather["wind_units"]=="mph"){echo $weather['wind_gust_speed']*2;}
if ($weather["wind_units"]=="kts"){echo $weather['wind_gust_speed']*2;}
if ($weather["wind_units"]=="m/s"){echo $weather['wind_gust_speed']*2;}
?>px;
