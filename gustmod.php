...
style="width:
<?php 
if ($weather["wind_units"]=="km/h"){echo $weather['wind_gust_speed']*1.4;}
if ($weather["wind_units"]=="mph"){echo $weather['wind_gust_speed']*1.5;}
if ($weather["wind_units"]=="kts"){echo $weather['wind_gust_speed']*1.5;}
