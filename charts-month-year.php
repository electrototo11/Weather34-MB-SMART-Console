<?php include('livedata.php');
	####################################################################################################
	#	CREATED FOR HOMEWEATHERSTATION stand alone version											   #
...
//path is weather34charts/year/month.csv (eg: weather34charts/2019/June.csv )
...
//(date month-year-0)),MAX(Temp-1),MIN(Temp-2),MAX(Dewpoint-3),MIN(Dewpoint-4),TOTAL(Raintoday-5),MAX(Windspeed-6),AVG(Day WindSpeed-7),AVG(Temp-8),MAX(Barometer-9),MIN(Barometer-10)
//path is weather34charts/year.csv (eg: weathercharts/2019.csv )
