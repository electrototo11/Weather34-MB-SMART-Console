...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["rainmmax"]."<smalltempunit2>".$weather["rain_units"];
...
echo "<div class=tempconverter1><div class=tempmodulehome0-5c>".$weather["rainydmax"]."<smalltempunit2>".$weather["rain_units"];
?><smalltempunit2></div></div></div>
