...
<style>
    ...
    .weatheroptions {
        ...
        border-bottom: 18px solid #3d464d;
        width: 95%;
    }
    ...
    <div class="loginformarea">
        ...
        function showForm($error = "LOGIN")
        {
            ...
            font-family:arial;padding:20px;border-radius:4px;border:1px solid rgba(74, 99, 111, 0.4);font-size:16px">
                <img src='weather34logo.svg' width='80px' style="float:left">

                <br>

                Welcome you have logged into the <br>WEATHER34 Console setup screen <?php echo date("M jS Y H:i"); ?>
                </span>
            </div>
    </div>
    </div>
