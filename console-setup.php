...
.updater a{background:#00a4b4;font-size:18px;color:#ffffff;position:relative;bottom:3px;margin:0 auto;width:300px;border-radius:3px;text-align:center;
padding:10px;}
blue{color:#00adbd }
    ...
    <div class="loginformarea">
        ...
        function showForm($error = "LOGIN")
        {
            ...
            <br>'; ?>
                ...
                <?php echo "2015-"; ?><?php echo date('Y'); ?> &copy;</a> WEATHER34 Console Version <blue>5.34</blue></span></span></span>

                <br><br>
                <center> 
                <a href="index.php" alt="return to dashboard" title="return to dashboard"> <?php 
                $backtohome='<svg width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="#00a4b4" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="#555" d="M0 0h24v24H0z" stroke-width="0"/><rect x="3" y="4" width="18" height="16" rx="3" /><circle cx="9" cy="10" r="2" stroke="#ccc"/><line x1="15" y1="8" x2="17" y2="8" stroke="#777"/><line x1="15" y1="12" x2="17" y2="12" stroke="#777"/>
                <line x1="7" y1="16" x2="17" y2="16" stroke="#777"/></svg>';                
                echo $backtohome ?></a></center>
...
<p>
            ...
            <div class="weatheroptions">
<div class="weathersectiontitle">
Language options based on ISO Language International Codes</span><br></div>
<br><br>
...
<center><div class="updater"><a href="weather34-updater.php" target="_blank">Click here to update this template using the latest update file if one is availble</a></div></center>
